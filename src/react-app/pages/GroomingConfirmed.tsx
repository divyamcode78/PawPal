...
export default function GroomingConfirmedPage() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => navigate('/bookings', { replace: true, state }), 800);
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/30 text-center">
          ...
          <div className="flex justify-center gap-3 mt-2">
            ...
            <button onClick={() => navigate('/bookings')} className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-full hover:from-orange-600 hover:to-pink-600">
              View My Bookings
